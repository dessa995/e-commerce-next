    ...
    <React.Fragment>
      <div className="flex justify-center flex-col items-center">
        ...
        <p className="text-grey-600 text-xl my-2 w-7/12">
          ...
          things to be done as of currently implemented features: style select
          and implement translate to it, probably correct implement translate,
          probably correct atomic design
        </p>
      </div>
